...
namespace Web.Api
{
    public class C03_EquiDataEntryController : ApiController
    {
        ...
        public string GetPageList(string para)
        {
            ...
            _model_ret.ret_status = obj.EDE_GetPageList(ref _model_ret.mrd01.dt);
        ...
        public string DoCheckData(string para)
        {
            ...
            if (obj.EDE_GetOne_ByDate(ref _model_ret.mrd01.dt) == (int)MyEnum.Enum_Ret.Succes)
            {
