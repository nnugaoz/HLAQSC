...
namespace MyTool.DB
{
    ...
    {
        protected static string connectionString = ConfigurationManager.AppSettings["ConnStr"];
        ...
        public static void ExecuteSqlTran_sort(Dictionary<string, object> SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
